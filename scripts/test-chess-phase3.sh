...
BUILD_DIR="$ROOT_DIR/build/chess-phase3"
...
gcc -std=c11 "$ROOT_DIR/tests/chess/phase3_search_harness.c" \
    "$BUILD_DIR/board.o" "$BUILD_DIR/fen.o" "$BUILD_DIR/attack.o" \
    "$BUILD_DIR/movegen.o" "$BUILD_DIR/makemove.o" "$BUILD_DIR/unmakemove.o" \
    "$BUILD_DIR/time.o" "$BUILD_DIR/eval.o" "$BUILD_DIR/uci.o" \
    "$BUILD_DIR/search.o" \
    -o "$BUILD_DIR/minicobc-phase3"

"$BUILD_DIR/minicobc-phase3" > "$BUILD_DIR/minicobc.out"

cobc -x -free \
    -I "$CHESS_DIR" \
    "$ROOT_DIR/tests/chess/phase3_search_ref.cob" \
    ...
    -o "$BUILD_DIR/gnucobol-phase3"

"$BUILD_DIR/gnucobol-phase3" > "$BUILD_DIR/gnucobol.out"
...
echo "phase3 chess SEARCH generic build matched GnuCOBOL"
